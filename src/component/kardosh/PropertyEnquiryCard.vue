...
const mailSubject = computed(() => {
  const title = props.property?.title || props.property?.name || 'Property enquiry'
...
.property-contact-card {
  ...
  --pcc-btn-primary-bg: #0f172a;
  --pcc-btn-primary-fg: #ffffff;
  --pcc-btn-primary-border: #0f172a;
...
.dark .property-contact-card {
  ...
  --pcc-btn-primary-bg: #ffffff;
  --pcc-btn-primary-fg: rgb(15 23 42);
  --pcc-btn-primary-border: #ffffff;
